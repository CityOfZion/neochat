...
import { REACT_APP_API_URL as API } from "babel-dotenv"
const WEBSOCKET_URL = API.replace(/(https|http)/, 'ws').replace('/api', ''); // new line
...
function setCurrentUser(dispatch, response) {
    ...
    dispatch(fetchUserChannels(response.data.id));
